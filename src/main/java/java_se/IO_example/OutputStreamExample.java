...
public class OutputStreamExample {
    public static void main(String[] args) throws IOException {
        String input_file = Paths.get("C:","Users","ikaros","Desktop","java_learn","src","main","resources","log4j.properties").toAbsolutePath().toString();
        String output_file = Paths.get("C:","Users","ikaros","Desktop","java_learn","src","main","resources","lllllog4j.properties").toAbsolutePath().toString();
        try(InputStream file_input_stream = new FileInputStream(input_file);
            OutputStream file_output_stream = new FileOutputStream(output_file)){
