...
public class ClassPathExample {
    ...
    public static void main(String[] args) {
        try {
            Properties prop = readClassPathExample("/log4j.properties");
            // 打印属性文件内容以便验证
    ...
    public static Properties readClassPathExample(String path) throws IOException {
        try (InputStream input = ClassPathExample.class.getResourceAsStream(path)) {
            if (input != null) {
